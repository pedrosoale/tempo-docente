...
const campo = CAMPOS_EXPERIENCIA_INFANTIL.find((item) => item.sigla === "ET")!;
...
export default async function CampoEspacosTemposQuantidadesRelacoesETransformacoesPage({ searchParams }: CampoPageProps) {
