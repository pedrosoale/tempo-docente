...
const campo = CAMPOS_EXPERIENCIA_INFANTIL.find((item) => item.sigla === "TS")!;
...
export default async function CampoTracosSonsCoresEFormasPage({ searchParams }: CampoPageProps) {
