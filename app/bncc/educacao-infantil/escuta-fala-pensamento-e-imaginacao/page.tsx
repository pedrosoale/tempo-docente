...
const campo = CAMPOS_EXPERIENCIA_INFANTIL.find((item) => item.sigla === "EF")!;
...
export default async function CampoEscutaFalaPensamentoEImaginacaoPage({ searchParams }: CampoPageProps) {
